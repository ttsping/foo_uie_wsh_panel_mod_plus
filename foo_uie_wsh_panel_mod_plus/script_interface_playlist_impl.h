...
public:
	...
	//PLUS
	static STDMETHODIMP GetPlaylistAutoName(UINT playlistIndex, BSTR* name);
	static STDMETHODIMP ProcessLocationsAsync(VARIANT urls);
...
public:
	...
	//plus
	STDMETHODIMP GetPlaylistAutoName(UINT playlistIndex, BSTR* name);
	STDMETHODIMP ProcessLocationsAsync(VARIANT urls);
